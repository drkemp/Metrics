...
*/    'push': function() {
  ...
  analytics.sendCommand('645-282','CCA', packageVersion, command)
  .then(commandActions[command]).done(function(){console.log("OK..");}, function(msg) {
    console.log("fail: ",msg);
    analytics.sendError('645-282','CCA', packageVersion, msg.code)
    .then(function(msg) {utils.fatal(msg)});
  });
}
